...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.voters.nicnepal.org"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="voters <noreply@api.voters.nicnepal.org>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [
    {"url": "https://api.voters.nicnepal.org", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
